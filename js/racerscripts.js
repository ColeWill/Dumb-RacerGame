...
$(document).ready(function(){
    ...
    function moveThis(key){
        ...
        */
        ...
        //jQueyr is using divSelectionText variable and add +20 to currentleft (a variable) and concatenate it with px to make it work in css ("has to be a string")
